...
from Models import *
from Dataset_Loader import my_datasetLoader
...
def check_input_size_model(input_image,required_size):   
...
#####################################################################################################################
## Modify here to select different models  
# name = 'unet'
# name = 'unet_bn'
name = 'unet_d'

## Uncomment the below function calls to train and test models 
# best_id, model = train_and_validateModel(name)
